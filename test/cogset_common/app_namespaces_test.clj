...
(deftest test-get-app-namespaces-existence
    ...
    (testing "if the cogset-common.app-namespaces/get-app-namespaces definition exists."
...
(deftest test-load-selected-namespace-existence
    ...
    (testing "if the cogset-common.app-namespaces/load-selected-namespace definition exists."
...
(deftest test-load-app-namespaces-existence
    ...
    (testing "if the cogset-common.app-namespaces/load-app-namespaces definition exists."
